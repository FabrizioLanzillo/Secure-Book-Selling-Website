            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if($sessionHandler->isLogged()){ ?>
                        <li class="nav-item">
                            <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/php/profile.php')?>">Hello, <?php echo htmlspecialchars($_SESSION['name'])?></a>
                        </li>
                    <?php } ?>
                    <li class="nav-item">
                        <?php if($sessionHandler->isLogged() and ($_SESSION['isAdmin'] == 1)){ ?>
                            <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/php/admin/homeAdmin.php')?>">Homepage</a>
                        <?php }else{ ?>
                            <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/')?>">Homepage</a>
                        <?php } ?>
                    </li>
                    <!-- The Orders Button for all the user pages -->
                    <?php if($sessionHandler->isLogged() and $_SESSION['isAdmin'] == 0){ ?>
                        <li class="nav-item">
                            <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/php/user/orders.php')?>">Orders</a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if((!$sessionHandler->isLogged() and (strcmp($currentFile, htmlspecialchars(SERVER_ROOT.'/index.php')) == 0)) or
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/php/user/shoppingCart.php')?>">Shopping Cart</a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if(!$sessionHandler->isLogged()){
                        if(strcmp($currentFile, htmlspecialchars(SERVER_ROOT.'/php/login.php')) != 0){ ?>
                            <li class="nav-item">
                                <a class="nav-link" href="//<?php echo htmlspecialchars(SERVER_ROOT. '/php/login.php')?>">Log In</a>
                            </li>
                        <?php }else{ ?>
                            <li class="nav-item">
