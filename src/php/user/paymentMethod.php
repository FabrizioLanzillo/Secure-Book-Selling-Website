            ...
            <div class="card rounded-4">
                <div class="card-body p-4 ">
                    ...
                    <form name="paymentInfoForm"
                          action="//<?php echo htmlspecialchars(SERVER_ROOT . '/php/user/paymentMethod.php'); ?>"
                          method="POST">
                        <div id="cardOptions">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg btn-block">Continue to Shipping Info
                            </button>
                        </div>
                    </form>
                </div>
